...
public:
    ...
    QLabel *mining4;
    QLabel *mining5;
    QLabel *mining_amount1;
    QLabel *mining_amount2;
    QLabel *mining_amount3;
    QLabel *mining_amount4;
    QLabel *mining_amount5;
    QPushButton *my_mining_button;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *BTL_GUIClass)
    {
        ...
        graphicsView->setGeometry(QRect(-90, -30, 1571, 971));
        ...
        miningresult->setGeometry(QRect(20, 370, 481, 161));
        ...
        mining1 = new QLabel(centralWidget);
        mining1->setObjectName(QString::fromUtf8("mining1"));
        mining1->setGeometry(QRect(30, 680, 451, 31));
        mining2 = new QLabel(centralWidget);
        mining2->setObjectName(QString::fromUtf8("mining2"));
        mining2->setGeometry(QRect(30, 710, 451, 31));
        mining3 = new QLabel(centralWidget);
        mining3->setObjectName(QString::fromUtf8("mining3"));
        mining3->setGeometry(QRect(29, 750, 460, 31));
        mining4 = new QLabel(centralWidget);
        mining4->setObjectName(QString::fromUtf8("mining4"));
        mining4->setGeometry(QRect(29, 800, 460, 31));
        mining5 = new QLabel(centralWidget);
        mining5->setObjectName(QString::fromUtf8("mining5"));
        mining5->setGeometry(QRect(30, 840, 451, 31));
        mining_amount1 = new QLabel(centralWidget);
        mining_amount1->setObjectName(QString::fromUtf8("mining_amount1"));
        mining_amount1->setGeometry(QRect(500, 680, 101, 31));
        mining_amount2 = new QLabel(centralWidget);
        mining_amount2->setObjectName(QString::fromUtf8("mining_amount2"));
        mining_amount2->setGeometry(QRect(500, 710, 101, 31));
        mining_amount3 = new QLabel(centralWidget);
        mining_amount3->setObjectName(QString::fromUtf8("mining_amount3"));
        mining_amount3->setGeometry(QRect(510, 750, 101, 31));
        mining_amount4 = new QLabel(centralWidget);
        mining_amount4->setObjectName(QString::fromUtf8("mining_amount4"));
        mining_amount4->setGeometry(QRect(520, 790, 101, 31));
        mining_amount5 = new QLabel(centralWidget);
        mining_amount5->setObjectName(QString::fromUtf8("mining_amount5"));
        mining_amount5->setGeometry(QRect(520, 830, 101, 31));
        my_mining_button = new QPushButton(centralWidget);
        my_mining_button->setObjectName(QString::fromUtf8("my_mining_button"));
        my_mining_button->setGeometry(QRect(650, 680, 75, 23));
        ...
        mining4->raise();
        mining5->raise();
        mining_amount1->raise();
        mining_amount2->raise();
        mining_amount3->raise();
        mining_amount4->raise();
        mining_amount5->raise();
        my_mining_button->raise();
    ...
    void retranslateUi(QMainWindow *BTL_GUIClass)
    {
        ...
        mining1->setText(QString());
        mining2->setText(QString());
        mining3->setText(QString());
        mining4->setText(QString());
        mining5->setText(QString());
        mining_amount1->setText(QString());
        mining_amount2->setText(QString());
        mining_amount3->setText(QString());
        mining_amount4->setText(QString());
        mining_amount5->setText(QString());
        my_mining_button->setText(QCoreApplication::translate("BTL_GUIClass", "\354\261\204\352\265\264 \353\252\251\353\241\235", nullptr));
    } // retranslateUi
